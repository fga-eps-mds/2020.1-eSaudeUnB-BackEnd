...
describe('Psychologist API', () => {
    ...
    it('should not be able to update a psychologist', async () => {
        ...
        const responseUpdate = await request.put(`/psyUpdate/${user1.email}`).send({
            name: '',
            lastName: 'abner',
            email: 'abcdefghij@hotmail.com',
            gender: 'M',
        ...
        const responseUpdate2 = await request.put(`/psyUpdate/${null}`).send({
            name: 'teste',
            lastName: 'abner',
            email: 'abcdefghij@hotmail.com',
            gender: 'M',
    ...
    it('should not be able to update a psychologist password', async () => {
        ...
        const responseIncorrectPass = await request
            .put(`/psyUpdatePassword/${user1.email}`)
            .send({ oldPassword: 'pass', password: 'monitor' }).set('authorization', TokenPsy);
